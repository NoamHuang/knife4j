...
package com.exc.kinfe4j.web.v2;
 ...
 * @since: 1.0
 */
@Api(tags = "Hello V2 排序1 类名C")
@ApiSort(1)
@CrossOrigin
@RestController
@RequestMapping("/v2/c")
public class V2HelloControllerC {
    private static final Logger logger = LoggerFactory.getLogger(V2HelloControllerC.class);
